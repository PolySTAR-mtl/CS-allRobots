	...
	*/
	...
	switch(pilot_id){ // Personalised configuration
		case PILOT_STANDARD:
			...
			pilot.sensitivity_mouse_x = 0.00008;
			pilot.sensitivity_mouse_y = 0.00005;

			pilot.sensitivity_chassis_keyboard_Vx = 3300;
			pilot.sensitivity_chassis_keyboard_Vy = 3300;
			pilot.sensitivity_chassis_rot = 2000;
			
			/* Chassis speed multipliers */
			pilot.coefficient_ShiftChassis = 1;
			pilot.coefficient_CTRLChassis = 0.35;
			break;
		case PILOT_HERO:
				/* Receiver */
			pilot.sensitivity_RC_deadzone = 10; //Between 0 and 6600
			pilot.sensitivity_ch_1 = 0.000015;  // Turret YAW
			pilot.sensitivity_ch_2 = 0.00001;  // Turret PITCH

			pilot.sensitivity_chassis_RC_Vx = 5; // TO DO : TESTER AVEC DES VALEURS PLUS PETITES SUR LE ROBOT
			pilot.sensitivity_chassis_RC_Vy = 5;
			pilot.sensitivity_chassis_RC_W = 2;
			
			/* Mouse Keyboard */
			pilot.sensitivity_mouse_deadzone = 5; //Between 0 and 6600
			pilot.sensitivity_mouse_x = 0.00003;
			pilot.sensitivity_mouse_y = 0.00003;

			pilot.sensitivity_chassis_keyboard_Vx = 3300;
			pilot.sensitivity_chassis_keyboard_Vy = 3300;
			pilot.sensitivity_chassis_rot = 2300;
